...
?>
      <form id="admin" action="admin.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/logo2.jpg" width="1330px" height="150px" style="box-shadow: 5px 0px 5px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <div class="container-fluid" id="dmid">    
             ...
             <div class="container">
                    <ul class="nav nav-tabs" >
                        ...
                        <li><a data-toggle="tab" href="#adomr">Respond Inquiries</a></li>
                        <li><a data-toggle="tab" href="#admarks">Add reporting dates</a></li>
                        ...
                        <li>  <input type="text" id="searchtb" name="searchtb" placeholder="Search" class="form-control" 
                           style="margin-top:5px;margin-left:150px;width:300px;"></li>
                    </ul>
	...
	?>
            ...
            <div class="container-fluid">
                <div class="row">
                   <div class="col-sm-12">
                       <br>
                       <h4><center>Set Reporting Dates</center></h4>
                   </div>
             </div>
                <div class="row">
                   <div class="col-sm-12">
                       <div class="container">
                        ...
                        <div class="row">
                                <div class="col-sm-6">  
                                      <input type="text" name="markof" id="search2" class="form-control" placeholder="DATE OF REPORTING" style="width:200px;"/>    
                                 </div>
                                 <div class="col-sm-6">  
