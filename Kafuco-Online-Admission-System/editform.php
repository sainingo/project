...
m_occ='$umocc', m_phn='$umphn', s_iop='$inc', s_sex='$gen', s_padr='$padr', s_pst='$past', s_ppin='$papin', s_pmob='$pamob', s_ruc='$rur', s_natn='$natn',
s_relg='$relg', s_catg='$cat', s_mainsxam='$oaco', s_branch='$brnc',s_college='$col', s_center='$cen', s_crtype='$crsty', s_tenbrd='$nob1', s_tenyop='$yop1', s_tentotmark='$tm1', s_tenmarkob='$mo1',
            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                   ...
                   <?php// <input type="text" id="uphn2" name="uphn2" value="<?php echo $row[3]  ?>
                  </tr>
